...
public class ParseAdapterTop2 extends RecyclerView.Adapter<ParseAdapterTop2.ViewHolder> {

    private ArrayList<ParseItemTop> parseItemsTop;
    private Context context;

    public ParseAdapterTop2(ArrayList<ParseItemTop> parseItemsTop, Context context) {
    ...
    @NonNull
    @Override
    public ParseAdapterTop2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.parse_item_top,parent, false);

        return new ParseAdapterTop2.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ParseAdapterTop2.ViewHolder holder, int position) {
